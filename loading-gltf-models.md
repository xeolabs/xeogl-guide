...
The following options may be specified when loading glTF:
 ...
 | outline | Boolean |  | false | When true, outlines all the model's Entities (see [Entity](http://xeogl.org/docs/classes/Entity.html) and [Outline](http://xeogl.org/docs/classes/OutlineMaterial.html)). |
